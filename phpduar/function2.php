...
<div class="discount">
    ...
    <div id="result" class="result">
        ...
        <input type='text' id="resultNama" readonly value="<?php echo $_POST['Nama']; ?>"><br />
        <label>Harga Barang :</label>
        <input type='text' id="resultHarga" readonly value="<?php echo $_POST['Harga']; ?>"><br />
        <label>Jumlah :</label>
        <input type='text' id="resultJumlah" readonly value="<?php echo $_POST['Jumlah']; ?>"><br />
        <label>Diskon :</label>
        <?php
            $harga = $_POST['Harga'];
            $jumlah = $_POST['Jumlah'];
